...
const Header = () => {
    return (
        <nav className="w-full py-6 bg-yellow-300 w-screen">
            <div className="flex items-center justify-between mx-auto xl:max-w-7xl lg:max-w-5xl md:max-w-3xl md:px-10 px-4">
                <section className="flex items-center text-gray-900 space-x-2">
                    ...
                    <NavLink to='/' className="font-bold text-xl outline-none rounded-lg">INVENTIVE</NavLink>
                </section>
                <section>
                    <ul className="md:space-x-8 space-x-6 text-gray-600 font-semibold hidden md:flex">
                        ...
                        <li><NavLink to='/login' className="bg-indigo-900 px-8 py-2 rounded-md text-white outline-none">Login</NavLink></li>
                    </ul>
                    {/* Small size icon */}
